...
#         print(v[2])
#         print(v[3])
        in_numpy= s.detach().cpu()
#         print("shape of in_numpy", in_numpy.shape)
      #  print(v==[1, 512, 32, 16])
        if(v[0]==1 and v[1]==512 and v[2]==32 and v[3]== 16):
            np.save('final_downsampled5',in_numpy)
        if(v[0]==1 and v[1]==512 and v[2]==64 and v[3]== 32):
            np.save('final_downsampled4',in_numpy)
        if(v[0]==1 and v[1]==256 and v[2]==128 and v[3]== 64):
            np.save('final_downsampled3',in_numpy)
        if(v[0]==1 and v[1]==128 and v[2]==256 and v[3]== 128):
            np.save('final_downsampled2',in_numpy)
